...
// EF Core — schema: cl_inpatient
builder.Services.AddDbContext<InpatientServiceDbContext>(opt =>
...
builder.Services.AddSingleton<InpatientServiceEventProducer>();

// Services & repositories
builder.Services.AddScoped<IAdmissionService, AdmissionService>();
builder.Services.AddScoped<IAdmissionRepository, AdmissionRepository>();
builder.Services.AddScoped<IAdmissionEligibilityService, AdmissionEligibilityService>();
builder.Services.AddScoped<IAdmissionEligibilityRepository, AdmissionEligibilityRepository>();
...
app.MapAdmissionEligibilityEndpoints();
