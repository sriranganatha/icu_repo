...
public sealed class DatabaseAgent : IAgent
{
    ...
    public async Task<AgentResult> ExecuteAsync(AgentContext context, CancellationToken ct = default)
    {
        ...
        _logger.LogInformation("DatabaseAgent starting — microservice-aligned generation for {Count} services",
            MicroserviceCatalog.All.Length);
            ...
            return new AgentResult
            {
                ...
                [
                    ...
                    new AgentMessage
                    {
                        ...
                        Body = $"{artifacts.Count} artifacts: per-service DbContexts, entities, repos, migrations."
                    }
                ],
                Duration = sw.Elapsed
            };
    ...
    private static CodeArtifact GenerateRlsMigration()
    {
        var policies = string.Join("\n\n", MicroserviceCatalog.All.SelectMany(svc =>
