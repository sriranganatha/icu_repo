...
namespace HmsAgents.Agents.Performance;
...
public sealed class PerformanceAgent : IAgent
{
    ...
    private static CodeArtifact GenerateResponseCacheProfile() => new()
    {
        ...
        RelativePath = "Hms.SharedKernel/Performance/CacheProfiles.cs",
    ...
    {
        Layer = ArtifactLayer.Configuration,
        RelativePath = "Hms.SharedKernel/Performance/HealthCheckOptimization.cs",
