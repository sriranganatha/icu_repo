...
namespace HmsAgents.Agents.UiUx;
        ...
        try
        {
            ...
            foreach (var (name, desc) in components)
            {
                ...
                artifacts.Add(new CodeArtifact
                {
                    ...
                    RelativePath = $"src/Hms.SharedKernel/Pages/Shared/_Components/{name}.cshtml",
                    FileName = $"{name}.cshtml",
                    Namespace = "Hms.SharedKernel.Pages",
                    ProducedBy = Type,
            ...
            {
                Layer = ArtifactLayer.RazorPage,
                RelativePath = "src/Hms.SharedKernel/wwwroot/css/hms-theme.css",
            ...
            {
                Layer = ArtifactLayer.RazorPage,
                RelativePath = "src/Hms.SharedKernel/Pages/Shared/_Layout.cshtml",
