...
namespace HmsAgents.Agents.Security;
...
public sealed class SecurityAgent : IAgent
{
    ...
    private static CodeArtifact GenerateInputValidationMiddleware() => new()
    {
        ...
        RelativePath = "Hms.SharedKernel/Security/InputValidationMiddleware.cs",
    ...
    {
        Layer = ArtifactLayer.Configuration,
        RelativePath = "Hms.SharedKernel/Security/RateLimitingPolicy.cs",
    ...
    {
        Layer = ArtifactLayer.Configuration,
        RelativePath = "Hms.SharedKernel/Security/SecurityHeadersMiddleware.cs",
    ...
    {
        Layer = ArtifactLayer.Configuration,
        RelativePath = "Hms.SharedKernel/Security/ApiKeyValidation.cs",
    ...
    {
        Layer = ArtifactLayer.Configuration,
        RelativePath = "Hms.SharedKernel/Security/DataEncryptionHelper.cs",
    ...
    {
        Layer = ArtifactLayer.Configuration,
        RelativePath = "Hms.SharedKernel/Security/PhiRedactionFilter.cs",
