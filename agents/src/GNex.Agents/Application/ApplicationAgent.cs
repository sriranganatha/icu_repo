...
namespace GNex.Agents.Application;
...
public sealed class ApplicationAgent : IAgent
{
    ...
    private static CodeArtifact GenerateGatewayProgram() => new()
    {
        ...
        RelativePath = "GNex.ApiGateway/Program.cs",
        FileName = "Program.cs",
        Namespace = "GNex.ApiGateway",
        ProducedBy = AgentType.Application,
        Content = """
            using GNex.SharedKernel.Middleware;
    ...
    private static CodeArtifact GenerateGatewayAppSettingsRoutes(IEnumerable<MicroserviceDefinition> services)
    {
        ...
        {
            Layer = ArtifactLayer.Configuration,
            RelativePath = "GNex.ApiGateway/appsettings.json",
    ...
    private static CodeArtifact GenerateGatewayDockerfile() => new()
    {
        ...
        Content = """
            ...
            ENTRYPOINT ["dotnet", "GNex.ApiGateway.dll"]
            """
    };
    ...
    {
        Layer = ArtifactLayer.Configuration,
        RelativePath = "GNex.SharedKernel/Middleware/TenantMiddleware.cs",
        FileName = "TenantMiddleware.cs",
        Namespace = "GNex.SharedKernel.Middleware",
        ProducedBy = AgentType.Application,
        Content = """
    ...
    {
        Layer = ArtifactLayer.Configuration,
        RelativePath = "GNex.SharedKernel/Middleware/CorrelationIdMiddleware.cs",
    ...
    {
        Layer = ArtifactLayer.Configuration,
        RelativePath = "GNex.SharedKernel/Middleware/GlobalExceptionMiddleware.cs",
